    ...
    return (
        <section className="login">
            ...
            <div className="login__wrapper">
                <form className="login__form" method="get" acceptCharset="utf-8" onSubmit={(evt) => handleClick(evt, 'user', user.login, user.password)}>
                    ...
                    <label className="login__label" htmlFor="pwd">
                        Пароль
                        <input className="login__input" type="password" placeholder="" onChange={(e) => handleChange(e)} required />
                    </label>
