...
function MovieShowHall() {
    ...
    const [seatsSource, setSeatsSource] = useState([]);
    ...
    return (
        <section className="buying">
            ...
            {order.length > 0 && <button className="accepting-button" onClick={handleSubmit} type="button">Забронировать</button>}
        </section>
    );
}
